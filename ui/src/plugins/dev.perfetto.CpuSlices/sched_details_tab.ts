  ...
  render() {
    ...
    return m(
      ...
      m(
        ...
        this.renderMtkSchedInfo(),
      ),
    );
  }

  private renderMtkSchedInfo(): m.Children {
    ...
    const treeNodes = [
      ...
      m(TreeNode, {
        left: 'Task Uclamp Min - Max',
        right: `0 - 1024`,
      }),
      m(TreeNode, {
        left: 'Task Effective Util',
        right: `123`,
      }),
      m(TreeNode, {
        left: 'CPU Util',
      ...
      m(TreeNode, {
        left: 'CPU Uclamp Min - Max',
        right: `0 - 1024`,
      }),
      m(TreeNode, {
        left: 'CPU Effective Util',
        right: `22`,
      }),
      m(TreeNode, {
        left: 'Task Priority',
    ...
    return m(Section, {title: 'MTK Sched Info'}, m(Tree, treeNodes));
  }
