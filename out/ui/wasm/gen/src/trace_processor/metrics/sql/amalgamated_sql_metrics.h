...
R"_d3l1m1t3r_(        'voltage_uv', voltage_uv
      )
    )
    FROM android_battery_charge
  ),
...
R"_d3l1m1t3r_(      'avg_power_from_charge_diff_mw',
...
R"_d3l1m1t3r_(FROM android_binder_client_breakdown GROUP BY binder_txn_id, reason
UNION ALL
...
R"_d3l1m1t3r_(        'client_tid', client_tid,
...
R"_d3l1m1t3r_(              'thread_state_count', thread_state_count
            )
...
R"_d3l1m1t3r_(DROP TABLE IF EXISTS rss_all_camera;
...
R"_d3l1m1t3r_(    AndroidIonMetric_Buffer(
      'name', heap_name,
      'avg_size_bytes', avg_size,
      'min_size_bytes', min_size,
      'max_size_bytes', max_size,
...
R"_d3l1m1t3r_(              'frame_dur_max', MAX(f.dur),
...
R"_d3l1m1t3r_(      SELECT COUNT(DISTINCT cpu) from sched
    ),
...
R"_d3l1m1t3r_(          "duration", startup_slice_proto(s.slice_dur),
...
R"_d3l1m1t3r_(      WHERE s.startup_id = launches.startup_id
    ),
...
R"_d3l1m1t3r_(        FROM _startup_events l
...
R"_d3l1m1t3r_(      'time_class_initialization',
...
R"_d3l1m1t3r_(        'Lock contention on a monitor*'
      ),
...
R"_d3l1m1t3r_(        'location', SUBSTR(STR_SPLIT(slice_name, ' status=', 0), LENGTH('location=') + 1),
...
R"_d3l1m1t3r_(        'dur_ns', slice_dur))
...
R"_d3l1m1t3r_(      count_slices_concurrent_to_launch(launches.startup_id, 'broadcastReceiveReg*'),
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW surfaceflinger_track AS
...
R"_d3l1m1t3r_(  'missed_frame_rate',
...
R"_d3l1m1t3r_(    'total_non_empty_gpu_waiting_dur_ms',
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW core_type_proto_per_thread_name AS
SELECT
utid,
...
R"_d3l1m1t3r_(-- are mapped to actual names of slices and then combined with other tables to
...
R"_d3l1m1t3r_(JOIN thread_slice t ON(sid = t.id)
...
R"_d3l1m1t3r_(SELECT AndroidCodecMetrics (
  'cpu_usage', (
    SELECT RepeatedField(
...
R"_d3l1m1t3r_(            'info', codec_power_mw.proto
          )
        ) FROM codec_power_mw
      )
    )
...
R"_d3l1m1t3r_(  -- Older builds don't have the state markers so we allow NULL but filter out
...
R"_d3l1m1t3r_(    JOIN actual_frame_timeline_slice timeline
      ON
...
R"_d3l1m1t3r_(      COALESCE(expected_timeline.dur, 16600000) AS dur_expected
...
R"_d3l1m1t3r_(      'thread_name', thread_name)))
  FROM (
...
R"_d3l1m1t3r_(    WHERE l.startup_id = $startup_id AND state GLOB $state AND l.is_main_thread
      AND p.startup_id = $startup_id
    ORDER BY dur DESC
    LIMIT $num_threads);
...
R"_d3l1m1t3r_(    'slice_section', RepeatedField(AndroidStartupMetric_TraceSliceSection(
      'thread_tid', tid,
      'process_pid', pid,
...
R"_d3l1m1t3r_(      AND p.startup_id = $startup_id
    ORDER BY slice_dur DESC
    LIMIT 1);
...
R"_d3l1m1t3r_(    AND slice.ts >= launches.ts
    AND (slice.ts + slice.dur) <= launches.ts_end
    LIMIT 1);
...
R"_d3l1m1t3r_(  startup_id LONG, threshold DOUBLE, num_slices INT)
RETURNS PROTO AS
  SELECT AndroidStartupMetric_TraceSliceSectionInfo(
    'slice_section', RepeatedField(AndroidStartupMetric_TraceSliceSection(
      'thread_tid', tid,
...
R"_d3l1m1t3r_(      WHERE s.startup_id = $startup_id AND slice_name GLOB "binder transaction"
...
R"_d3l1m1t3r_(        'additional_info', extra))
      FROM (
        SELECT 'No baseline or cloud profiles' as slow_cause,
...
R"_d3l1m1t3r_(          'WARNING' as severity,
          AndroidStartupMetric_ThresholdValue(
...
R"_d3l1m1t3r_(          'Lock contention on*'
...
R"_d3l1m1t3r_(            (SELECT pid FROM android_startup_processes WHERE launch.startup_id = startup_id))
            as trace_slices,
...
R"_d3l1m1t3r_(          get_slices_concurrent_to_launch(launch.startup_id, 'Broadcast dispatched*', 3,
            (SELECT pid FROM android_startup_processes WHERE launch.startup_id = startup_id))
            as trace_slices,
          NULL as trace_threads,
          NULL as extra
...
R"_d3l1m1t3r_(              'broadcastReceiveReg*')) as actual_val,
...
R"_d3l1m1t3r_(          get_main_thread_binder_transactions_blocked(launch.startup_id, 2e7, 3)
            as trace_slices,
          NULL as trace_threads,
          NULL as extra
        FROM android_startups launch
...
const char kAndroidStartupSlowStartThresholds[] = R"_d3l1m1t3r_(--
-- Copyright 2022 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(  15 AS verify_classes_percentage,
...
R"_d3l1m1t3r_(  FROM slow_start_thresholds;
...
const char kAndroidWattsonAppStartupRails[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
const char kAndroidWattsonAtraceAppsRails[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(  'window_table', '_wattson_cuj_windows'
);
...
const char kAndroidWattsonMarkersRails[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
const char kAndroidWattsonMarkersThreads[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
const char kAndroidWattsonTasksAttribution[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW _wattson_thread_attribution AS
SELECT
...
const char kAndroidWattsonTraceRails[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW wattson_trace_rails_output AS
SELECT AndroidWattsonTimePeriodMetric(
  'metric_version', 4,
  'power_model_version', 1,
  'period_info', (
...
const char kAndroidWattsonTraceThreads[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
const char kChromeChromeHistogramSummaries[] = R"_d3l1m1t3r_(--
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(    CAST(PERCENTILE(hist.value, 50) AS INTEGER) AS p50_histval
...
R"_d3l1m1t3r_(DROP VIEW IF EXISTS chrome_flow_slices_for_gestures;
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW chrome_first_flow_per_gesture
AS
SELECT
  *
FROM
...
R"_d3l1m1t3r_(          chrome_gestures.id
        FROM
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW chrome_update_count_per_scroll AS
SELECT
...
R"_d3l1m1t3r_(-- current scroll update.
...
const char kChromeChromeStudyHashes[] = R"_d3l1m1t3r_(--
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
const FileToSql kFileToSql[] = {
  ...
  {"android/startup/slow_start_thresholds.sql", kAndroidStartupSlowStartThresholds},
  ...
  {"android/wattson_app_startup_rails.sql", kAndroidWattsonAppStartupRails},

  {"android/wattson_atrace_apps_rails.sql", kAndroidWattsonAtraceAppsRails},

  {"android/wattson_markers_rails.sql", kAndroidWattsonMarkersRails},

  {"android/wattson_markers_threads.sql", kAndroidWattsonMarkersThreads},

  {"android/wattson_rail_relations.sql", kAndroidWattsonRailRelations},

  {"android/wattson_tasks_attribution.sql", kAndroidWattsonTasksAttribution},

  {"android/wattson_trace_rails.sql", kAndroidWattsonTraceRails},

  {"android/wattson_trace_threads.sql", kAndroidWattsonTraceThreads},
  ...
  {"chrome/chrome_histogram_summaries.sql", kChromeChromeHistogramSummaries},
  ...
  {"chrome/chrome_study_hashes.sql", kChromeChromeStudyHashes},
