 ...
 public:
  ...
  class ConstRowReference : public macros_internal::AbstractConstRowReference<
   ...
   public:
    ...
    ColumnType::field_type::type field_type() const {
      return table()->field_type()[row_number_];
    }
  ...
  class RowReference : public ConstRowReference {
   ...
   private:
    ExperimentalProtoPathTable* mutable_table() const {
      return const_cast<ExperimentalProtoPathTable*>(table());
    }
  };
  ...
  class ConstIterator : public macros_internal::AbstractConstIterator<
   ...
   public:
    ...
    ColumnType::field_type::type field_type() const {
      const auto& col = table()->field_type();
      return col.GetAtIdx(
        iterator_.StorageIndexForColumn(col.index_in_table()));
    }
    ColumnType::field_name::type field_name() const {
  ...
  class Iterator : public ConstIterator {
    public:
     RowReference row_reference() const {
       return {const_cast<ExperimentalProtoPathTable*>(table()), CurrentRowNumber()};
     }
 ...
 public:
  ...
  class ConstRowReference : public macros_internal::AbstractConstRowReference<
   ...
   public:
    ...
    ColumnType::path_id::type path_id() const {
      return table()->path_id()[row_number_];
    }
    ColumnType::total_size::type total_size() const {
      return table()->total_size()[row_number_];
    }
  ...
  class RowReference : public ConstRowReference {
   ...
   private:
    ExperimentalProtoContentTable* mutable_table() const {
      return const_cast<ExperimentalProtoContentTable*>(table());
    }
  };
  static_assert(std::is_trivially_destructible_v<RowReference>,
                "Inheritance used without trivial destruction");
  ...
  class ConstIterator : public macros_internal::AbstractConstIterator<
   ...
   public:
    ...
    ColumnType::path_id::type path_id() const {
      const auto& col = table()->path_id();
      return col.GetAtIdx(
        iterator_.StorageIndexForColumn(col.index_in_table()));
    }
    ColumnType::total_size::type total_size() const {
      const auto& col = table()->total_size();
      return col.GetAtIdx(
        iterator_.StorageIndexForColumn(col.index_in_table()));
    }
    ColumnType::size::type size() const {
  ...
  class Iterator : public ConstIterator {
    public:
     RowReference row_reference() const {
       return {const_cast<ExperimentalProtoContentTable*>(table()), CurrentRowNumber()};
     }
